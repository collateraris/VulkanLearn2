...
void VulkanReSTIRInitPlusTemporalPass::init(VulkanEngine* engine, VkAccelerationStructureKHR  tlas, std::array<AllocatedBuffer, 2>& globalUniformsBuffer, AllocatedBuffer& objectBuffer)
{
	_engine = engine;
...
void VulkanReSTIRInitPlusTemporalPass::init_description_set()
{
	VkSamplerCreateInfo samplerInfo = vkinit::sampler_create_info(VK_FILTER_NEAREST);
